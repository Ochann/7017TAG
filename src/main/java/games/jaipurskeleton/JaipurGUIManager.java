...
public class JaipurGUIManager extends AbstractGUIManager {
    ...
    public static HashMap<JaipurCard.GoodType, Color> goodColorMapping = new HashMap<JaipurCard.GoodType, Color>() {{
        ...
        put(Magic, new Color(10, 220, 220));
    }};
    ...
    private String getRuleText(JaipurParameters params) {
        ...
        rules += "<p>Players have " + params.nInitialCardsInHand +" cards in hand at the beginning of the game.</p><br/>";
        rules += "<p>Players have a hand limit of " + params.nPlayerHandLimit + " cards. Camel cards go in a separate pile and don't count towards this limit.</p><br/>";
        ...
        rules += "<p>The market must be replenished to " + params.nMaximumCardsInMarket + "cards after every player action.</p><br/>";
